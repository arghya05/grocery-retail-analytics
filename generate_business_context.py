#!/usr/bin/env python3
"""
Generate comprehensive business context metadata for the Store Manager AI Assistant
This creates a rich context file that helps the LLM understand the business deeply
"""
...
def generate_business_context():
    """Generate comprehensive business context from all data sources"""
    ...
    context['business_overview'] = {
        ...
        'sku_count': 59,
        'customer_base': '199,981 unique customers',
        'annual_revenue': '₹682.3M',
        'data_period': 'January 2022 - December 2023 (24 months)',
        'total_transactions': '1,869,621'
    }

    # ===== KEY BUSINESS INSIGHTS =====
    context['critical_insights'] = {
        'strengths': [
            ...
            'Consistent store performance across regions (₹13.6M avg per store)',
            'High transaction volume during evening hours (45% between 4-9 PM)'
        ],
        'opportunities': [
            'Perishable wastage costing ₹15-20M annually - immediate action needed',
            'Promotions reducing average transaction value by ₹155 - strategy broken',
        ...
        'quick_wins': [
            'Implement aggressive markdown on perishables (save ₹8-12M annually)',
            'Fix evening staffing (add 40% more cashiers 4-9 PM)',
            'Ensure top 20 products never stock out (capture ₹5M lost sales)',
            'Launch VIP program for top 2,000 customers (protect ₹33M revenue)'
        ]
    }

    # ===== CATEGORY INTELLIGENCE =====
    context['category_intelligence'] = {
        'Beverages': {
            'revenue': '₹163.5M',
            'share': '23.96%',
        ...
        'Staples & Grains': {
            ...
            'top_products': ['Rice 10kg (₹31.2M)', 'Basmati Rice 5kg (₹24.8M)'],
        ...
        'Household Items': {
            'revenue': '₹61.3M',
            'avg_transaction': '₹510.77 (highest)',
    ...
    context['customer_intelligence'] = {
        ...
        'Premium': {
            'count': '186,391 (93.2%)',
            'revenue': '₹218.8M (32.1%)',
            'avg_transaction': '₹417.93 (45% higher than Occasional)',
    ...
    context['operational_intelligence'] = {
        'peak_hours': {
        ...
        'weekend_performance': {
            ...
            'avg_value': '₹376.02 (+4.1% vs weekday)',
    ...
    context['inventory_intelligence'] = {
        ...
        'perishable_management': {
            ...
            'wastage_cost': '₹15-20M annually - IMMEDIATE ACTION NEEDED',
            'potential_savings': '₹8-12M with proper management'
        },
        'slow_movers': {
            'action_items': [
                ...
                'Reduce working capital by ₹3M'
            ]
        }
    }

    # ===== PRICING & PROMOTION INTELLIGENCE =====
    context['pricing_intelligence'] = {
        'discount_problem': {
            'issue': 'Promotions REDUCING avg transaction by ₹155',
            'current_promo_avg': '₹234.99',
            'non_promo_avg': '₹389.87',
            'root_cause': 'Attracting small-basket shoppers, heavy discounting on low-margin items',
            'solution': 'Minimum spend thresholds - "Spend ₹500, get 20% off"',
        ...
        'dynamic_pricing': {
            ...
            'expected_impact': '₹15M revenue uplift'
        }
    }

    # ===== SEASONAL INTELLIGENCE =====
    context['seasonal_intelligence'] = {
        'Winter': {
            'months': 'Oct-Feb',
    ...
    context['store_intelligence'] = {
        ...
        'bottom_performers': {
            ...
            'root_causes': ['Product mix', 'Merchandising', 'Staff training', 'Local preferences'],
            'action_plan': [
            ...
            'potential_uplift': '₹10-12M annually'
        },
        'format_performance': {
            'Hypermarket': '₹304.0M (44.5%) - Best performers, larger baskets',
            'Supermarket': '₹218.7M (32.1%) - Balanced format',
            'Express': '₹159.6M (23.4%) - Convenience, smaller baskets'
        }
    }
    ...
    context['competitive_intelligence'] = {
        'vs_industry_benchmarks': {
            'daily_revenue': '₹934,631 vs ₹800,000 benchmark - ABOVE',
    ...
    context['financial_opportunities'] = {
        'total_potential': '₹304M incremental revenue (44.5% growth)',
        'breakdown': [
            {'initiative': 'Fix Promotions Strategy', 'impact': '₹93M', 'timeline': 'Month 1', 'roi': '9,200%'},
            {'initiative': 'Convert Occasional to Regular', 'impact': '₹60M', 'timeline': 'Month 1', 'roi': '1,900%'},
            {'initiative': 'Improve Bottom Stores', 'impact': '₹40M', 'timeline': 'Month 3', 'roi': '400%'},
            {'initiative': 'VIP Customer Program', 'impact': '₹33M', 'timeline': 'Month 1', 'roi': '560%'},
            {'initiative': 'Seasonal Planning', 'impact': '₹25M', 'timeline': 'Month 2', 'roi': '2,400%'},
            {'initiative': 'Bundle Strategy', 'impact': '₹18M', 'timeline': 'Month 3', 'roi': '1,700%'},
            {'initiative': 'Dynamic Pricing', 'impact': '₹15M', 'timeline': 'Month 2', 'roi': '1,400%'},
            {'initiative': 'Reduce Wastage', 'impact': '₹12M', 'timeline': 'Week 1', 'roi': '500%'},
            {'initiative': 'Critical Stock Management', 'impact': '₹5M', 'timeline': 'Week 1', 'roi': '400%'},
            {'initiative': 'Digital Payment Push', 'impact': '₹3M', 'timeline': 'Month 3', 'roi': '50%'}
        ],
        'priority_sequence': [
    ...
    # ===== STORE MANAGER LANGUAGE & TERMINOLOGY =====
    context['business_terminology'] = {
        'kpis': {
...
def save_context_to_json():
    ...
    with open('business_context_metadata.json', 'w') as f:
        json.dump(context, f, indent=2)

    print("✓ Generated business_context_metadata.json")
    print(f"  - Persona definition")
    print(f"  - Business overview")
    print(f"  - Critical insights")
    print(f"  - Category intelligence")
    print(f"  - Customer intelligence")
    print(f"  - Operational intelligence")
    print(f"  - Inventory intelligence")
    print(f"  - Pricing intelligence")
    print(f"  - Seasonal intelligence")
    print(f"  - Store intelligence")
    print(f"  - Competitive positioning")
    print(f"  - Financial opportunities")
    print(f"  - Business terminology")
    print(f"  - Response patterns")

if __name__ == "__main__":
    save_context_to_json()
    print("\n✓ Business context metadata generated successfully!")
