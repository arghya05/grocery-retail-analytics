#!/usr/bin/env python3
"""
CEO Story with Summary-First Structure Generator
Creates CEO briefing with impactful summary first, then detailed analysis for each section
"""
...
class CEOStorySummaryFirstGenerator:
...
================================================================================"""
    ...
    def generate_q1_business_360(self) -> str:
        """Generate Q1 with summary first, then details"""
        return """================================================================================
                    Q1 — BUSINESS 360
                            [60 SECONDS]
================================================================================
...
================================================================================"""
    ...
    def generate_q2_customer_drivers(self) -> str:
        """Generate Q2 with summary first, then details"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_q3_operational_efficiency(self) -> str:
        """Generate Q3 with summary first, then details"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_q4_gmroi_margin_growth(self) -> str:
        """Generate Q4 with summary first, then details"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_q5_workforce_outlook(self) -> str:
        """Generate Q5 with summary first, then details"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_q6_ai_innovation_roi(self) -> str:
        """Generate Q6 with summary first, then details"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_strategic_focus_initiative(self) -> str:
        """Generate Strategic Focus Initiative with summary first"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_strategic_narrative(self) -> str:
        """Generate strategic narrative with summary first"""
        return """================================================================================
...
================================================================================"""
    ...
    def generate_complete_story(self) -> str:
        """Generate the complete CEO story with summary-first structure"""
        story_parts = [
    ...
    def save_story(self, output_file: str = None):
        ...
        if output_file is None:
            output_file = f"{self.data_folder}/ceo_story_summary_first.txt"
        ...
        print(f"CEO story with summary-first structure generated and saved to: {output_file}")
...
def main():
    """Main function to generate CEO story with summary-first structure"""
    print("CEO Story with Summary-First Structure Generator")
    print("=" * 60)
    
    # Initialize generator
    generator = CEOStorySummaryFirstGenerator()
    
    # Generate and save story
    output_file = generator.save_story()
    
    print("\nCEO Story with Summary-First Structure Generation Complete!")
    print(f"Output file: {output_file}")
    print("\nFeatures included:")
    print("✅ Summary-First Structure: Impactful summary at the top of each section")
    print("✅ Q1 — Business 360: Summary → Story → Descriptive → Predictive → Root Cause → Prescriptive")
    print("✅ Q2 — Customer Drivers: Summary → Story → Detailed Analysis")
    print("✅ Q3 — Operational Efficiency: Summary → Story → Detailed Analysis")
    print("✅ Q4 — GMROI & Margin Growth: Summary → Story → Detailed Analysis")
    print("✅ Q5 — Workforce Outlook: Summary → Story → Detailed Analysis")
    print("✅ Q6 — AI/Innovation ROI: Summary → Story → Detailed Analysis")
    print("✅ Strategic Focus Initiative: Summary → Story → Detailed Analysis")
    print("✅ Strategic Narrative: Summary → Story → Detailed Analysis")
    ...
    print("✅ Impactful summaries: Short, crisp narratives leading each section")
